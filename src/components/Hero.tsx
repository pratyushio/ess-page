  ...
  return (
    <section className="min-h-screen bg-black text-gray-400 flex items-center justify-center">
      <div className="max-w-[900px] pt-8 max-sm:pt-16 px-4 flex flex-col gap-8 items-center justify-between z-20">
        ...
        <a href="https://github.com/Essential-network/ess-app-release/releases/download/v0.1/essential_v01.apk" className="flex items-center bg-orange-600 text-white text-lg px-4 h-10 rounded-lg font-semibold hover:bg-orange-700">Download App</a>
